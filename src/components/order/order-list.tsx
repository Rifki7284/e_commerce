    ...
    <>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-7xl">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-slate-400 text-sm sm:text-base ml-[52px]">
            View your digital purchases and downloads
          </p>
        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center gap-1.5 text-xs font-bold uppercase px-3 py-1.5 rounded-lg border ${statusStyle.bgColor} ${statusStyle.color}`}
                          >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                          <button
                            onClick={() =>
                              router.push(`/orders/${order.transactionId}`)
                            }
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span
                          className={`inline-flex items-center gap-1 text-xs font-bold uppercase px-2 py-1 rounded-md border ${statusStyle.bgColor} ${statusStyle.color}`}
                        >
